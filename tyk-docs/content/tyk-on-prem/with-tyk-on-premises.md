...
<!-- todo: oss labels: -->
* [Tyk Gateway](/docs/getting-started/tyk-components/gateway/):  The API Gateway proxies and manages your traffic. Tyk Gateway enables your organization to control who can access your APIs, when they can access, and how they can access it.
